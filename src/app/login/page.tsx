    ...
    <div style={{ minHeight: "100vh", background: "#080c14", display: "flex", alignItems: "center", justifyContent: "center", fontFamily: "'DM Sans', sans-serif", padding: 24 }}>
      <div style={{ width: "100%", maxWidth: 420 }}>
        ...
        <div style={{ textAlign: "center", marginBottom: 40 }}>
          ...
          <p style={{ color: "#6b7a99", fontSize: 14, marginTop: 8 }}>Sign in to your account</p>
        </div>
        ...
        <div style={{ background: "#0e1520", border: "1px solid rgba(255,255,255,0.08)", borderRadius: 16, padding: 32 }}>
          ...
          <div style={{ display: "flex", flexDirection: "column", gap: 14 }}>
            <div>
              <label style={{ fontSize: 12, color: "#6b7a99", display: "block", marginBottom: 6, textTransform: "uppercase", letterSpacing: "0.08em" }}>Email</label>
              <input
                type="email"
                value={email}
            ...
            <div>
              <label style={{ fontSize: 12, color: "#6b7a99", display: "block", marginBottom: 6, textTransform: "uppercase", letterSpacing: "0.08em" }}>Password</label>
              <input
                type="password"
                value={password}
            ...
            <button
              onClick={handleLogin}
              disabled={loading}
              style={{ background: loading ? "rgba(249,115,22,0.5)" : "#f97316", color: "#fff", border: "none", borderRadius: 10, padding: "13px", fontSize: 15, fontWeight: 600, cursor: loading ? "not-allowed" : "pointer", marginTop: 4, transition: "all 0.2s" }}
            >
        ...
        <p style={{ textAlign: "center", fontSize: 14, color: "#6b7a99", marginTop: 20 }}>
          ...
          <Link href="/signup" style={{ color: "#f97316", textDecoration: "none", fontWeight: 600 }}>Sign up free</Link>
        </p>
      </div>
